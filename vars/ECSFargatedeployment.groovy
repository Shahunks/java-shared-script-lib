        ...
        stages {
            ...
            stage('Deploy') {
                steps {
                    ...
                    sh "aws ecs update-service --service my-first-service --task-definition my-first-task --cli-input-json file://var/jenkins_home/workspace/ECS/ECS-fargate-deploymenttask-definition.json --region ap-southeast-2 > /dev/null"
