        ...
        stages {
            ...
            stage('Deploy') {
                steps {
                    ...
                    sh 'aws ecs register-task-definition --family my-first-task --cli-input-json file:///var/jenkins_home/workspace/ECS/ECS-fargate-deployment/task-definition.json'
                    }
                    }
                }
            }
